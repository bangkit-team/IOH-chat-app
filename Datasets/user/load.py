...
def load_dummyktp():
    with open("./src/dummy-ktp.json") as _:
        f = json.load(_)
...
def load_wilayah():
    ...
    with open("./src/kecamatan.csv") as _:
        csvreader = csv.reader(_)
        next(csvreader)
        code_kecamatan = []
    ...
    with open("./src/kabupaten.csv") as _:
        csvreader = csv.reader(_)
        next(csvreader)
        code_kabupaten = []
    ...
    with open("./src/provinsi.csv") as _:
        csvreader = csv.reader(_)
        next(csvreader)
        code_provinsi = []
